...
OUT=output
MODEL_NAME=CoMPILE
DATASET_NAME=fb237_v4
DATA_PATH=$DATA_DIR/$DATASET_NAME
DB_PATH=$DATA_DIR/fb237_v4_subgraph
TEST_DB_PATH=$DATA_DIR/fb237_v4_ind/test_subgraphs
PK_PATH=$DATA_DIR/fb237_v4.pkl
...
CALC_HITS=1,5,10
GPU=1
CHECKPOINT_DIR=output/link_prediction/fb237_v4/CoMPILE/epoch\=22-Eval\|aoc\=0.939.ckpt
