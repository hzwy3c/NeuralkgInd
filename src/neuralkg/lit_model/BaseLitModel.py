...
class BaseLitModel(pl.LightningModule):
    ...
    def get_auc(self, results, mode):
        ...
        outputs["|".join([mode, "aoc"])] = metrics.roc_auc_score(pos_labels + neg_labels, pos_scores + neg_scores)
        outputs["|".join([mode, "aoc_pr"])] = metrics.average_precision_score(pos_labels + neg_labels, pos_scores + neg_scores)
        return outputs
