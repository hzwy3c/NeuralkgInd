...
class DglSampler2(GraphSampler):
...
class ValidDglSampler(object):
    ...
    def sampling(self, data):
        ...
        batch_data["positive_sample"] = (batched_graph_pos, r_labels_pos)
        batch_data["negative_sample"] = (batched_graph_neg, r_labels_neg)
        batch_data["graph_pos_label"] =  g_labels_pos
        batch_data["graph_neg_label"] =  g_labels_neg

        return batch_data

class ValidDglSampler2(object):
    def __init__(self, sampler):
        self.sampler = sampler
        self.args = sampler.args
